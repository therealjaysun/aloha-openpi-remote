...
S0827's arm-explicit matrix and exact coverage/timing amendment are complete. The amendment does not reopen phases 00–06.
...
| SP04 | Preserve finite ALOHA `(14,)` observation/applied-action and `(50,14)` model-response contracts with fixed arm-explicit top-camera prompt input | S0827 | contract tests + profile smoke | Pass: E-MAC-S0827, E-PC-S0827 |
