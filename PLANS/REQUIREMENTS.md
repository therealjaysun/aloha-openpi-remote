...
| DOD15 | Server remains valid across setup/check SSH sessions while WSL is active; Phase 03 owns persistence after Windows would otherwise stop idle WSL | 02,03 | Phase 02 cross-session pass for both profiles; idle-host persistence pending final Phase 03 holder acceptance | E-PC-BF16 |
