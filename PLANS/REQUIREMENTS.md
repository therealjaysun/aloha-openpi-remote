...
| G03 | `pi0_aloha_sim` is the task-specific default; `pi05_aloha_base` is optional and explicitly experimental | 02–06 | server metadata and docs | Pass through Phase 02: E-MAC02, E-PC-BF16 |
| G04 | Policy hosts are loopback; Mac reaches WSL only through authenticated SSH local forwarding | 02,03,06 | listener/routing checks | Pending Mac tunnel; WSL loopback passed E-PC-BF16 |
...
| G08 | Exact upstream pin and Mac/WSL project SHA are recorded before remote tests | 00,02–06 | Git evidence | Pass through Phase 02: E-PC-SETUP, E-PC-BF16 |
| G09 | Weights, checkpoints, caches, raw logs/telemetry, videos, and machine paths remain ignored | 00–06 | tracked/candidate scan | Pass through Phase 02: E-MAC03 |
...
| PH16 | Fail-closed secret scan runs before every push | 00–06 | PR/evidence record | Pass through Phase 02: E-MAC03 |
| PH17 | Staged and non-ignored candidate files are inspected before every push | 00–06 | PR/evidence record | Pass through Phase 02: E-MAC03 |
...
| DR17 | Configured local/remote port conflicts | 02,03 | listener checks | Pending: Phase 03 Mac tunnel port; WSL port gate passed E-PC-SETUP |
...
| DOD07 | All phase branches are pushed | 00–06 | Pending: phases 00–02 pushed | E-GH, E-MAC02 |
| DOD08 | Seven-PR stack exists | 00–06 | Pending: PRs 1–3 exist | E-GH, E-MAC02 |
| DOD09 | PRs remain open for human review | 00–06 | Pending: PRs 1–3 open; later PRs not created | E-GH, E-MAC02 |
...
| DOD15 | Server persists after setup SSH exits | 02 | Pass for both profiles | E-PC-BF16 |
| DOD16 | Mac reaches server through SSH tunnel | 03 | Pending Phase 03 | — |
| DOD17 | Smoke test returns finite expected action chunk | 02,03 | Pass at Phase 02 WSL boundary for both profiles | E-PC-BF16 |
| DOD18 | Mac executes returned actions in MuJoCo | 04 | Pending Phase 04 | — |
| DOD19 | At least one complete policy-controlled episode runs | 04 | Pending Phase 04 | — |
| DOD20 | Videos and structured metrics are saved | 04,05 | Pending policy runs; Phase 01 sim video passed | E-MAC01 |
| DOD21 | GPU memory and inference latency are reported | 02,05 | Pass for Phase 02; final aggregation remains Phase 05 | E-PC-BF16 |
| DOD22 | Unit tests pass | 00–06 | Pass through Phase 02 locally and hosted: E-MAC03 | E-MAC03 |
| DOD23 | Relevant upstream checks pass or exact infeasible lane is recorded | 00,06 | Pending | — |
| DOD24 | CPU-only public CI is configured where practical | 00 | Pass: hosted checks are green through Phase 02 | E-GH, E-MAC03 |
| DOD25 | No credentials or machine secrets are committed | 00–06 | Pass through Phase 02: E-MAC03 | E-MAC03 |
| DOD26 | Public-repository hygiene passes | 00,06 | Pass through Phase 02: E-MAC03 | E-MAC03 |
