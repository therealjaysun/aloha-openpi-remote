...
- **Objective:** Evaluate one active ALOHA arm pushing two independently initialized rigid lowercase `p` and `i` bodies onto their respective targets.
