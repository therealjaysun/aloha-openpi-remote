...
- **Validation:** Keep historical locked results labeled. Current π₀.₅ checkpoint comparisons run exactly 6,000 seed-0 steps; require complete 14-D command pass-through, no prompt transitions, exact coverage/joint/video rows, a `224×672` ordered MP4, valid plot/GPU metrics, visual inspection across all panels, and clean stop.
