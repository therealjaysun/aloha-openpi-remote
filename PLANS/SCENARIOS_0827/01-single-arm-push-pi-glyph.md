...
- **Remaining blockers:** Exact-candidate three-view hardware evidence. PR 7 ancestry remains a merge-order dependency, not a technical blocker.
- **Completion status:** Three-view amendment active; E-MAC/E-PC-S0827-VIEWS pending. Earlier coverage, long-run, and six-episode results remain historical top-only evidence.
