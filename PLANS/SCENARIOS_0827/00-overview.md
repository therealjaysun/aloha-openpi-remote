...
- **Current status:** Coverage/timing amendment active. Prior 24-episode evidence remains historical; completion requires the exact amended Mac candidate and one bounded π₀ Scenario 1 run.
