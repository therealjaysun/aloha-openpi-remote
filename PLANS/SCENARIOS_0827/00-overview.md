...
- **Current status:** Complete on implementation candidate `7c2ec5927ad200e5aaf30bed0db4ef61cb9e2ba4`; final evidence is in E-MAC-S0827 and E-PC-S0827. PR 8 remains based on PR 7 until the stack merges.
- **Actual results:** All four Gym IDs compile/reset on the pinned Mac stack. The frozen descriptor is `9942fa7e851e352c2e7717e84a9fe1cb66b07f61c96fa62d9df136cefc6b154b`. Four canonical 300-step pushes achieved `+0.117..+0.215 m` Y motion, exact named contact, at most `0.00638 m` height deviation, and at most `0.00882 rad` parked-arm error. Every randomized/canonical body and target exceeded 20 policy pixels; four reset images and four display-on smokes passed. The two exact hardware matrices completed 24/24 infrastructure-valid episodes, 7,200/7,200 steps and trajectory samples, and 24/24 videos and 14-joint plots. All episodes reached the 300-step limit with zero contact, lift, fall, off-table, or task success; this is an honest zero-shot result, not an infrastructure failure. Maximum telemetry-write p95 was `0.190 ms`.
...
- **Validated implementation SHA:** `7c2ec5927ad200e5aaf30bed0db4ef61cb9e2ba4`.
...
- Extend publishable telemetry with fixed scenario/task allowlists and compact safe fields only: scenario, scene hash, episode/sample/artifact counts, terminal counts, push-success count, bounded aggregate errors/contact counts, and safe local IDs. Reject arbitrary prompts/paths and omit raw poses, machine identifiers, absolute paths, and detailed JSONL.
