...
| S0827 Push-PI | Arm-explicit prompts pass the exact Mac gate; PC revalidation pending | `codex/push-pi-scenarios` | 8 | [PR 8](https://github.com/therealjaysun/pi-robotics/pull/8) | `codex/06-hardening-docs` | `codex/push-pi-scenarios` | 396 passed + 1 platform skip; lint/format/Bash; exact calibration; stock, four hold, and four visual smokes pass | Run both exact PC profile matrices; prior 24-episode evidence is historical for the previous prompts | Prompt implementation `9b82fab`; final evidence pending |
...
- Machine gate: **ON**. Rerun both exact-SHA 12-episode matrices because the language input changed; prior matrix evidence remains historical.
