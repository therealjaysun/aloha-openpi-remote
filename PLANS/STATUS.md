...
Planning baseline: 2026-08-26. Plans are complete; phases 00–04 are implemented, published, and validated. Phase 05 observability is next.
...
| 04 End-to-end | Complete; open for review | `codex/04-end-to-end-control` | 5 | [PR 5](https://github.com/therealjaysun/pi-robotics/pull/5) | `codex/03-secure-connectivity` | `codex/04-end-to-end-control` | 205 local tests plus lint/format/shell/secret scan pass; Mac 900-step smoke passed; both exact-candidate profiles completed three episodes with six decoded videos and clean stops | None; sustained 50 Hz was not claimed (45.44–47.09 Hz measured) | Hardware implementation `0fca61f`; final evidence at branch HEAD |
...
- Active subphase: 05.01 metrics schema when Phase 05 implementation is requested.
- Machine gate: none. Phase 04 stopped every owned component; the RTX PC may be powered off until Phase 05 hardware validation.
...
- Last verified Mac/WSL hardware candidate SHA: `0fca61f796f018706d1af51d00ab562b68509eef`; upstream SHA: `215abfb217dbac7d5f1273282331b9b1866c0479`.
- PR state: PRs 1–5 are open; PR 5 hosted checks are pending final evidence push, and PRs 6–7 remain pending. No auto-merge is enabled.
