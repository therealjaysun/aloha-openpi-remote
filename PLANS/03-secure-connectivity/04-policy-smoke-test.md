...
- **Remaining blockers:** Tunnel and remote server for hardware evidence. WebSockets 14.1 already exposes `open_timeout`, `close_timeout`, `recv(timeout=...)`, and `close()`; API discovery is not a blocker.
