...
- **Implementation tasks:** Complete `REQUIREMENTS.md` DOC01–DOC22; document `OPENPI_POLICY_PROFILE` with user-selected π₀.₅ default/experimental caveat and π₀ task-specific option; add a compact upstream-differences inventory, architecture/data contracts, and exact troubleshooting tree; keep commands copyable.
